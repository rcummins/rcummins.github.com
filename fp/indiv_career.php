...
* Final Project
*
* Displays a graph that shows the race pace throughout the career of the
* person whose name was specified in the previous page. Also displays a 
* table with all the races run by that person.
**********************************************************************/
      ...
      <tr>
        ...
        <td width="240px">
          <div class="register">
            ...
            <!-- Links to the Harvard Course PRs Pages -->
            <p>
        ...
        <td>
          <div class="report">
            ...
            <!-- title: Career Report for [name] -->
            <h3>Career Report for <? print($_GET["name"]) ?></h3><br />
            <br />
              ...
              <? // prepare sql to get races run, times from Results table
                ...
                // chart title = Career Mile Pace
                ?>&chtt=Career+Mile+Pace<?
        ...
        <td>
          <div class="report">
            <table border="1" cellpadding="5px" rules="rows" >
              ...
              <div align="center">
              <!-- print headers for table showing person's career history -->
              <tr>
              ...
              <? // prepare sql to get races run, times from Results table
                 ...
                 while ($row = mysql_fetch_array($result))
                 {
                   ...
                   $query2 = sprintf("SELECT 
                                      date, course_name, length, event_name
                                      FROM Courses WHERE race_date_num=%d"
                                      ,$row["race_date_num"]);
                   ...
                   <!-- print rows for table showing person's career history -->
                   <tr>
